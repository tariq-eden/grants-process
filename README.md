...
- When pull request is opened in *RAT*, create an *item* (in the Data Management group) and sync future changes from GitHub (note, it doesn't need to be merged - just opened). 
