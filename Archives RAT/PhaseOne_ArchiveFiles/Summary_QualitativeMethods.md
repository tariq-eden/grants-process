...
1. Justification_Comments Files (Textual Responses by Claim): each row functions as a unit of textual data (either a justification or a comment), with a column for each of the characteristics of those responses (including a column for linking that data to the other file types). Also see, an [archived example of this file type](https://github.com/metamelb-repliCATS/RAT/blob/drafts/Archives%20RAT/PhaseOne_ArchiveFiles/Examples/BatchName_justifications_comments_2020-09-01.xlsx)

2. Ratings_by_claim Files (Numerical Responses by Claim): with one row for each participant per round per claim, columns were included for each question as well as for additional characteristics of those responses (including a column for linking that data to the other file types). Also see, an [archived example of this file type](https://github.com/metamelb-repliCATS/RAT/blob/drafts/Archives%20RAT/PhaseOne_ArchiveFiles/Examples/BatchName_ratings_by_claim_2020-09-01.xlsx)

3. Claim_Metadata Files: with one row per claim, columns were included for each of the characteristics of that claim (based on COS metadata for each claim: Claim id; journal; COS journal discipline; Web of science discipline). Also see, an [archived example of this file type](https://github.com/metamelb-repliCATS/RAT/blob/drafts/Archives%20RAT/PhaseOne_ArchiveFiles/Examples/BatchName_claim_metadata_2020-09-01.xlsx)

4. Demographics File: with one row per participant, and columns for each of the demographic questions asked and each quiz-question answered. Also see, an [archived example of this file type](https://github.com/metamelb-repliCATS/RAT/blob/drafts/Archives%20RAT/PhaseOne_ArchiveFiles/Examples/demographics_annon_2020-07-30.xlsx)
...
These [reasonWAgg Categories](https://github.com/metamelb-repliCATS/RAT/blob/drafts/Archives%20RAT/PhaseOne_ArchiveFiles/Examples/reasonWAggCategories_SummaryV5.docx) included 25 nodes [selected from the main Codebook](https://github.com/metamelb-repliCATS/RAT/blob/drafts/Archives%20RAT/PhaseOne_ArchiveFiles/Examples/Reconciling_CodebookV10_with_reasonWAggCategoriesV5_Archived.xlsx).
